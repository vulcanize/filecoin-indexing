...
CREATE TABLE IF NOT EXISTS filecoin.market_deal_proposals (
    ...
    block_cid               BIGINT NOT NULL, -- do we need to use parent_state_root instead? Since we are processing finalized proposals and not pending ones, we should have the block_cid (and block_cid will map to b parent_state_root in filecoin.block_headers)
