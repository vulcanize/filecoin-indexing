...
SELECT create_hypertable('filecoin.reward_actor_state', 'block_number', migrate_data => true, chunk_time_interval => 2880);
...
SELECT create_hypertable('filecoin.storage_actor_locked_tokens', 'block_number', migrate_data => true, chunk_time_interval => 2880);
SELECT create_hypertable('filecoin.miner_actor_state', 'block_number', migrate_data => true, chunk_time_interval => 2880);
SELECT create_hypertable('filecoin.miner_infos', 'block_number', migrate_data => true, chunk_time_interval => 2880);
SELECT create_hypertable('filecoin.miner_vesting_funds', 'block_number', migrate_data => true, chunk_time_interval => 2880);
SELECT create_hypertable('filecoin.miner_deadlines', 'block_number', migrate_data => true, chunk_time_interval => 2880);
...
SELECT create_hypertable('filecoin.miner_sector_infos', 'block_number', migrate_data => true, chunk_time_interval => 2880);
SELECT create_hypertable('filecoin.miner_partitions', 'block_number', migrate_data => true, chunk_time_interval => 2880);
...
SELECT create_hypertable('filecoin.storage_power_actor_state', 'block_number', migrate_data => true, chunk_time_interval => 2880);
...
SELECT create_hypertable('filecoin.storage_power_claims', 'block_number', migrate_data => true, chunk_time_interval => 2880);
...
SELECT create_hypertable('filecoin.fevm_actor_state', 'block_number', migrate_data => true, chunk_time_interval => 2880);
SELECT create_hypertable('filecoin.fevm_actor_storage', 'block_number', migrate_data => true, chunk_time_interval => 2880);
...
ALTER TABLE filecoin.actor_states_i RENAME TO actor_states;
...
ALTER TABLE filecoin.storage_actor_deal_states_i RENAME TO storage_actor_deal_states;
...
ALTER TABLE filecoin.payment_channel_lane_states_i RENAME TO payment_channel_lane_states;
