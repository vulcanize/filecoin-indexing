...
SELECT create_hypertable('filecoin.actor_states', 'height', migrate_data => true, chunk_time_interval => 2880);
...
SELECT create_hypertable('filecoin.storage_actor_deal_states', 'height', migrate_data => true, chunk_time_interval => 2880);
...
SELECT create_hypertable('filecoin.payment_channel_lane_states', 'height', migrate_data => true, chunk_time_interval => 2880);
