...
CREATE TABLE IF NOT EXISTS filecoin.reward_actor_state (
    ...
    total_mined                NUMERIC, -- NOT NULL in v0, NULL in v2
    total_storage_power_reward NUMERIC, -- NOT NULL in v2, NULL in v0
    simple_total               NUMERIC, -- NOT NULL in v2, NULL in v0
    baseline_total             NUMERIC, -- NOT NULL in v2, NULL in v0
...
-- maps m-to-1 to a miner_actor_state
...
CREATE TABLE IF NOT EXISTS filecoin.storage_power_actor_state (
    ...
    proof_validation_batch_root_cid  TEXT,   -- NOT NULL in v0, NULL or NOT NULL in v2
